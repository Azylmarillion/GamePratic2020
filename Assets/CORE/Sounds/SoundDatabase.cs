...
namespace GamePratic2020
{
	...
	public class SoundDatabase : ScriptableObject
    {
        ...
        [HorizontalLine(1, order = 0), Section("Ambiances", order = 1)]
        [SerializeField] private AudioClip crushingAmbiance = null; 
        [SerializeField] private AudioClip furnaceAmbiance = null; 
        [SerializeField] private AudioClip wagonAmbiance = null;
        ...
        public AudioClip CrushingAmbiance => crushingAmbiance;
        public AudioClip FurnaceAmbiance => furnaceAmbiance;
        public AudioClip WagonAmbiance => wagonAmbiance;
